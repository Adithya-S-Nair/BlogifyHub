...
function Authpage() {
    ...
    return (
        <>
            ...
            <MDBContainer className="p-3 my-5 d-flex flex-column w-25 mt-5">
                    ...
                    <MDBTabsPane show={justifyActive === 'tab2'}>
                        <form onSubmit={handleRegisterSubmit}>
                            ...
                            <div className='d-flex justify-content-center mb-4'>
                                <MDBCheckbox name='flexCheck' id='flexCheckDefault' label='I have read and agree to the terms' checked />
                            </div>
